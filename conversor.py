...
class Conversor:
    def __init__(self):
        self.re_unidade_medida = "(?:ha|hectare|hectares|al|alqs|alqueire|alqueires|ac|acre|acres|milesimo|milésimo|milesimos|milésimos|lt|lts|litro|litros|milha|milhas|milha2|milha quadrada|milhas quadradas|decimo milesimo|décimo milésimo|decimos milesimos|décimos milésimos|decimo milesimos|décimo milésimos|selamim|salamim|celamim|metro|metros|metro2|metros2|metro quadrado|metros quadrados)"
        ...
        self.re_unidade_metro = "(?:metro|metros|metro2|metros2|metro quadrado|metros quadrados)"
        self.re_valores = "\d+(?:\.\d*)?"
    ...
    def devolver_calculo(self, unidade):
        ...
        if len(re.findall(self.re_unidade_metro, unidade)) > 0:
            return lambda a : (a / 10000)
